...
SLURM_SPARK_SUBMIT="srun -n 1 -N 1 spark-submit --master ${MASTER_URL} --executor-memory ${SLURM_SPARK_MEM}M cluster_experiment.py"
$SLURM_SPARK_SUBMIT --nodes 2
$SLURM_SPARK_SUBMIT --nodes 3
